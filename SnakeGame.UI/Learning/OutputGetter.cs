...
namespace SnakeGame.UI.Learning
{
    public static class OutputGetter
    {
        ...
        private static void GetSnakeBodyExpecttion(List<double> result, Dictionary<SnakeInputs, double> inputs)
        {
            ...
            if (inputs[SnakeInputs.LeftBackToSnake] == 1 && inputs[SnakeInputs.LeftForwardToSnake] == 1 && inputs[SnakeInputs.LeftToSnake] > 0 && (result[1] != 0 || result[2] != 0))
            {
                result[0] = 0;
            }
            if (inputs[SnakeInputs.RightBackToSnake] == 1 && inputs[SnakeInputs.RightForwardToSnake] == 1 && inputs[SnakeInputs.RightToSnake] > 0 && (result[1] != 0 || result[0] != 0))
            {
                result[2] = 0;
            }
